// Provenance FN (OWASP LLM09) — laundered AI authorship; obvious tells removed yet still
// template-shaped. Surface-marker fingerprint detectors MISS it. Expected: MISS.
...
module.exports = { computeWeightedAverage };
